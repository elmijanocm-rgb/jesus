...
function displayRegistrosArchivados() {
    ...
    registrosArchivados.forEach((registro, index) => {
        ...
        iconRow.innerHTML = `<td colspan="${totalColumns}" style="text-align: left !important; padding: 8px; border-bottom: 2px solid #ddd;">
            <div style="display: flex !important; flex-direction: row !important; gap: 5px; align-items: center; justify-content: flex-start !important; flex-wrap: nowrap; padding-left: 0px !important; margin-left: 0px !important;">
