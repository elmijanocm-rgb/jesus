...
function displayRegistrosArchivados() {
    ...
    registrosArchivados.forEach((registro, index) => {
        ...
        iconRow.innerHTML = `<td colspan="${totalColumns}" style="text-align: left !important; padding: 8px !important; border-bottom: 2px solid #ddd; margin: 0 !important;">
            <div style="display: flex !important; flex-direction: row !important; gap: 5px !important; align-items: center !important; justify-content: flex-start !important; flex-wrap: nowrap !important; padding: 0 !important; margin: 0 !important; width: 100% !important; box-sizing: border-box !important;">
                <button class="btn small-btn" onclick="verDetalleRegistro(${index})" title="Ver detalle" style="width: 35px !important; height: 35px !important; min-width: 35px !important; margin: 0 !important; padding: 5px !important;"><i class="fas fa-eye"></i></button>
                <button class="btn small-btn" onclick="exportarRegistroIndividualPDF(${index})" title="Exportar a PDF" style="width: 35px !important; height: 35px !important; min-width: 35px !important; background-color: #28a745 !important; margin: 0 !important; padding: 5px !important;"><i class="fas fa-file-pdf"></i></button>
                <button class="btn small-btn danger-btn" onclick="eliminarRegistroArchivado(${index})" title="Eliminar registro" style="width: 35px !important; height: 35px !important; min-width: 35px !important; margin: 0 !important; padding: 5px !important;"><i class="fas fa-trash"></i></button>
            </div>
        </td>`;
